...
%%%%%%
%please change the folder path to the folder where you want the images to
%be saved
...
NUM_epochs = [200];
hidden_layer_sizes = [300];%[200,300,500];
...
%%for the display
network = sprintf('%d --> %d --> %d',input_dimension,hidden_layer,output_dimension);
